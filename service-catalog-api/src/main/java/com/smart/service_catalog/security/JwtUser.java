...
public class JwtUser implements UserDetails {
	...
	private static final long serialVersionUID = 4449730152890920413L;
	...
	public JwtUser(Long id, String username, String firstname, String lastname, String email, String password,
			Collection<? extends GrantedAuthority> authorities, boolean enabled, Date lastPasswordResetDate, Role role) {
		this.id = id;
